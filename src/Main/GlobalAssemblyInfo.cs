...
[assembly: AssemblyCopyright("2000-2021 AlphaSierraPapa for the SharpDevelop Team")]
[assembly: AssemblyVersion(RevisionClass.Major + "." + RevisionClass.Minor + "." + RevisionClass.Build + "." + RevisionClass.Revision)]
[assembly: AssemblyInformationalVersion(RevisionClass.FullVersion + "-1cfe96d5")]
...
internal static class RevisionClass
{
	...
	public const string Revision = "9722";
	...
	public const string FullVersion = Major + "." + Minor + "." + Build + ".9722";
}
